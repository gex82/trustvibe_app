...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "newProject.linkedContractorLocked": "Linked contractor is locked for this request.",
    ...
    "workflow.profile.availability": "Availability",
    ...
    "workflow.notifications.sectionToday": "Today",
    "workflow.notifications.read": "Read",
    "workflow.notifications.unread": "Unread",
    "workflow.notifications.itemEscrowFundedTitle": "Escrow is funded",
    "workflow.notifications.itemEscrowFundedDescription":
      "Your project funds are protected and ready for work to begin.",
    "workflow.notifications.itemEscrowFundedTime": "2m ago",
    "workflow.notifications.itemQuoteTitle": "New quote submitted",
    "workflow.notifications.itemQuoteDescription":
      "Juan's Home Services sent a quote for your bathroom project.",
    "workflow.notifications.itemQuoteTime": "1h ago",
    "workflow.notifications.itemReviewTitle": "Review reminder",
    "workflow.notifications.itemReviewDescription":
      "Leave a review after release to help improve contractor trust scores.",
    "workflow.notifications.itemReviewTime": "Yesterday",
    "workflow.payments.title": "Payment Methods",
    "workflow.payments.subtitle": "Card and payout method management surface.",
    "workflow.payments.primaryTitle": "Primary card",
    "workflow.payments.primaryMasked": "Visa ending in 4242 • Expires 10/29",
    "workflow.payments.primaryBilling": "Billing profile: Maria Rodriguez (San Juan, PR)",
    "workflow.payments.default": "Default",
    "workflow.payments.addMethodTitle": "Add backup method",
    "workflow.payments.addMethodSubtitle":
      "Preview flow for adding card or ACH account in production.",
    "workflow.payments.addMethodCta": "Add method",
    "workflow.settings.title": "Settings",
    "workflow.settings.subtitle": "Language, privacy, and account controls.",
    "workflow.settings.languageTitle": "Language preferences",
    "workflow.settings.languageSubtitle": "Switch UI language instantly across customer, contractor, and admin views.",
    "workflow.settings.privacyTitle": "Security and privacy",
    "workflow.settings.privacySubtitle": "Manage login safety, account sessions, and notification permissions.",
    "workflow.settings.supportTitle": "Support and contact",
    "workflow.settings.supportSubtitle": "Reach concierge support for escrow, disputes, and urgent account help.",
    ...
    "workflow.availability.day.mon": "Monday",
    "workflow.availability.day.tue": "Tuesday",
    "workflow.availability.day.wed": "Wednesday",
    "workflow.availability.day.thu": "Thursday",
    "workflow.availability.day.fri": "Friday",
    "workflow.availability.available": "Available",
    "workflow.availability.unavailable": "Unavailable",
    "workflow.availability.windowMorning": "8:00 AM - 11:00 AM",
    "workflow.availability.windowMidday": "11:00 AM - 2:00 PM",
    "workflow.availability.windowAfternoon": "2:00 PM - 6:00 PM",
    "workflow.availability.notSet": "No time window",
    "workflow.availability.changeWindow": "Change window",
    "workflow.availability.save": "Save availability",
    "workflow.availability.saved": "Availability preferences saved for demo session.",
  },
  ...
  es: {
    ...
    "newProject.linkedContractorLocked": "El contratista vinculado queda fijo para esta solicitud.",
    "newProject.invalidContractorWarning":
      "El enlace del contratista no es válido. Continúa publicando una solicitud general.",
    ...
    "workflow.profile.availability": "Disponibilidad",
    ...
    "workflow.notifications.sectionToday": "Hoy",
    "workflow.notifications.read": "Leída",
    "workflow.notifications.unread": "Nueva",
    "workflow.notifications.itemEscrowFundedTitle": "Escrow fondeado",
    "workflow.notifications.itemEscrowFundedDescription":
      "Tus fondos del proyecto están protegidos y listos para comenzar.",
    "workflow.notifications.itemEscrowFundedTime": "Hace 2 min",
    "workflow.notifications.itemQuoteTitle": "Nueva cotización enviada",
    "workflow.notifications.itemQuoteDescription":
      "Servicios del Hogar de Juan envió una cotización para tu proyecto de baño.",
    "workflow.notifications.itemQuoteTime": "Hace 1 h",
    "workflow.notifications.itemReviewTitle": "Recordatorio de reseña",
    "workflow.notifications.itemReviewDescription":
      "Deja una reseña después de liberar fondos para fortalecer la confianza.",
    "workflow.notifications.itemReviewTime": "Ayer",
    "workflow.payments.title": "Métodos de Pago",
    "workflow.payments.subtitle": "Superficie de gestión de tarjetas y métodos de cobro.",
    "workflow.payments.primaryTitle": "Tarjeta principal",
    "workflow.payments.primaryMasked": "Visa terminada en 4242 • Expira 10/29",
    "workflow.payments.primaryBilling": "Perfil de facturación: Maria Rodriguez (San Juan, PR)",
    "workflow.payments.default": "Predeterminada",
    "workflow.payments.addMethodTitle": "Agregar método de respaldo",
    "workflow.payments.addMethodSubtitle":
      "Vista previa para añadir tarjeta o cuenta ACH en producción.",
    "workflow.payments.addMethodCta": "Agregar método",
    "workflow.settings.title": "Configuración",
    "workflow.settings.subtitle": "Controles de idioma, privacidad y cuenta.",
    "workflow.settings.languageTitle": "Preferencias de idioma",
    "workflow.settings.languageSubtitle":
      "Cambia el idioma de inmediato en vistas de cliente, contratista y admin.",
    "workflow.settings.privacyTitle": "Seguridad y privacidad",
    "workflow.settings.privacySubtitle":
      "Administra seguridad de acceso, sesiones y permisos de notificaciones.",
    "workflow.settings.supportTitle": "Soporte y contacto",
    "workflow.settings.supportSubtitle":
      "Contacta soporte concierge para escrow, disputas y ayuda urgente.",
    ...
    "workflow.availability.day.mon": "Lunes",
    "workflow.availability.day.tue": "Martes",
    "workflow.availability.day.wed": "Miércoles",
    "workflow.availability.day.thu": "Jueves",
    "workflow.availability.day.fri": "Viernes",
    "workflow.availability.available": "Disponible",
    "workflow.availability.unavailable": "No disponible",
    "workflow.availability.windowMorning": "8:00 AM - 11:00 AM",
    "workflow.availability.windowMidday": "11:00 AM - 2:00 PM",
    "workflow.availability.windowAfternoon": "2:00 PM - 6:00 PM",
    "workflow.availability.notSet": "Sin horario asignado",
    "workflow.availability.changeWindow": "Cambiar horario",
    "workflow.availability.save": "Guardar disponibilidad",
    "workflow.availability.saved": "Disponibilidad guardada para la sesión demo.",
  },
};
